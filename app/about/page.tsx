    ...
    <div className="relative min-h-[calc(100vh-5rem)] bg-gradient-to-b from-blue-50 to-cyan-50 text-slate-800 py-10 px-2 flex items-center justify-center overflow-hidden">
      ...
      <div style={animatedBorder} className="relative w-[100%] mx-auto rounded-3xl z-10">
        <div style={cardStyle} className="rounded-3xl p-8 md:p-14">
          ...
          >
            🧭 About Us – The Real Story Behind <span className="text-cyan-700">Leadzoro</span>
          </motion.h1>
          ...
          >
            ...
            <p className="text-lg text-slate-700">
              ...
              That individual was <span className="font-semibold text-cyan-700">Ashutosh Pandey</span> — a marketer who believed in results before reputation. No investors, no hype, just a laptop, a deep understanding of digital growth, and a dream to help Indian businesses scale profitably.<br />
          ...
          >
            ...
            <p className="text-lg text-slate-700">
              ...
              You'll land here — because <span className="font-semibold text-cyan-700">Ashutosh Pandey</span> is the brain, heart, and hustle behind Leadzoro.<br />
          ...
          >
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-slate-50 rounded-xl p-4 border border-cyan-100/60 shadow flex items-start gap-3">
                ...
                <div>
                  <div className="text-slate-800">"Leadzoro gave my business more than leads — they gave me a direction."</div>
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="text-2xl font-bold text-slate-900">📌 Behind the Name: Why "Leadzoro"?</h2>
            </div>
            <p className="text-lg text-slate-700 mb-4">
          ...
          >
            ...
            <p className="text-cyan-600 mb-8">…then maybe, just maybe, you're ready for Leadzoro.<br />We're not perfect. But we are obsessed with getting your brand the growth it deserves.</p>
          </motion.div>
          ...
          >
            ...
            <ul className="list-none text-slate-700 mb-6 pl-4 space-y-2">
              <li>📧 <a href="mailto:hello@leadzoro.com" className="text-cyan-700 hover:underline">hello@leadzoro.com</a></li>
              <li>🌐 <a href="https://www.leadzoro.com" target="_blank" rel="noopener noreferrer" className="text-cyan-700 hover:underline">www.leadzoro.com</a></li>
